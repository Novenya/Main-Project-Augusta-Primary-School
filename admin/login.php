...
<body style="background-color: #0b0471;" class="hold-transition login-page">
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b><img src="../images/logo.png" width="250" height="250"></b><span class="style1"></span></a>  </div>
  <!-- /.login-logo -->
  <div class="card">
