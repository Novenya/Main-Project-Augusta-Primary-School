...
<div class="wrapper">
  ...
  <aside style="background-color: #0b0471;" class="main-sidebar sidebar-dark-primary elevation-4">
   ...
   <a href="#" class="brand-link">
      <img src="../images/logo.png" alt=" Logo" width="250" height="250" style="opacity: .8">
          ...
          <table width="1161" border="0" align="center">
            <tr>
              <td width="1155"><div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                  <table style="background-color:#c7deea;" width="85%" align="center" class="table table-bordered table-striped" id="example1">
                    <thead>
                      <tr> <th width="3%">ID</th>
                        ...
                        <th width="7%">SEX</th>
					              <th width="7%">GRADE</th>
                        <th width="9%">City</th>
                        <th width="7%">GARDIAN NIC</th>
                       
                        <th width="7%">YEAR</th>
						            <th width="8%">PAYMENT RECIEPT</th>
                        <th width="8%">Photo</th>
                     ...
                     while($row = $result->fetch_assoc()) { 
                      ...
                      <tr class="gradeX">
                        ...
                        <td><span class="style6">
                          <?php if(($row['status'])==((1)))
                        { ?>
                        <a href="admit_exec.php?id=<?php echo $row['ID'];?>" ><strong>Cancel Admission</strong> </a> 
                          <?php } else {?>
                        <a href="admit_exec.php?uid=<?php echo $row['ID'];?>" ><strong>Admit </strong></a> 
                         <?php } ?>
					               <a href="delete-user.php?id=<?php echo $row['ID'];?>" onClick="return deldata('<?php echo $row['fullname']; ?>');"><strong>Delete</strong> </a>
